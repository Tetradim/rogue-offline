...
import { analyzePokeRogueTarget } from './server/target-discovery.js'
import { verifyTargetBuild } from './server/target-verifier.js'

const modulePath = fileURLToPath(import.meta.url)
const toolRoot = path.dirname(modulePath)
...
function projectFromManifest(manifest, targetDir) {
...
export { parseArgs, projectFromManifest }
